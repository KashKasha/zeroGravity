...
/**
 * Navigation icon paths (SVG d attributes).
...
export const NAV_ICONS = {
  ...
  apiReference: "M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4",
  forum:
...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "API Reference",
        href: ROUTES.API_REFERENCE,
        icon: NAV_ICONS.apiReference,
        color: "cyan",
      },
      {
        label: "Community Forum",
        href: ROUTES.FORUM,
        icon: NAV_ICONS.forum,
        color: "indigo",
      },
    ],
  },
...
/**
 * Group color mapping for navigation sections.
 */
