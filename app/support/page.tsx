    ...
    <AppShell>
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className={`text-2xl font-bold ${
            isLight
              ? "text-zinc-800"
              : "bg-gradient-to-r from-zinc-100 via-zinc-200 to-zinc-400 bg-clip-text text-transparent"
          }`}>
            Support Center
          </h1>
          <p className={`text-sm mt-1 ${isLight ? "text-zinc-600" : "text-zinc-500"}`}>Get help from our team or browse documentation</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className={`group relative rounded-2xl p-6 text-center overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5 ${
          isLight
            ? "bg-white border border-zinc-200 hover:border-emerald-500/30 hover:shadow-zinc-200/50"
            : "bg-gradient-to-br from-[#1E1E21] to-[#1a1a1d] border border-[#2A2A2E] hover:border-emerald-500/30 hover:shadow-black/20"
        }`}>
          ...
          <div className="relative">
            <div className="w-14 h-14 rounded-2xl bg-emerald-500/10 text-emerald-400 ring-1 ring-emerald-500/20 flex items-center justify-center mx-auto mb-4 group-hover:scale-105 transition-transform">
            ...
            <button className="w-full mt-5 h-10 rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-400 hover:to-emerald-500 text-white text-sm font-semibold transition-all shadow-lg shadow-emerald-500/25 hover:shadow-emerald-500/40">
              Start Chat
            </button>
          </div>
        </div>
        ...
        <div className={`group relative rounded-2xl p-6 text-center overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5 ${
          isLight
            ? "bg-white border border-zinc-200 hover:border-sky-500/30 hover:shadow-zinc-200/50"
            : "bg-gradient-to-br from-[#1E1E21] to-[#1a1a1d] border border-[#2A2A2E] hover:border-sky-500/30 hover:shadow-black/20"
        }`}>
          ...
          <div className="relative">
            <div className="w-14 h-14 rounded-2xl bg-sky-500/10 text-sky-400 ring-1 ring-sky-500/20 flex items-center justify-center mx-auto mb-4 group-hover:scale-105 transition-transform">
              <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
            ...
            <p className="text-sm text-sky-400 font-medium mt-3">support@limewp.com</p>
            <button className="w-full mt-5 h-10 rounded-xl bg-sky-500/10 hover:bg-sky-500/20 text-sky-400 text-sm font-semibold transition-all border border-sky-500/20 hover:border-sky-500/40">
              Send Email
            </button>
          </div>
        </div>
        ...
        <div className={`group relative rounded-2xl p-6 text-center overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5 ${
          isLight
            ? "bg-white border border-zinc-200 hover:border-violet-500/30 hover:shadow-zinc-200/50"
            : "bg-gradient-to-br from-[#1E1E21] to-[#1a1a1d] border border-[#2A2A2E] hover:border-violet-500/30 hover:shadow-black/20"
        }`}>
          ...
          <div className="relative">
            <div className="w-14 h-14 rounded-2xl bg-violet-500/10 text-violet-400 ring-1 ring-violet-500/20 flex items-center justify-center mx-auto mb-4 group-hover:scale-105 transition-transform">
              <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="flex items-center justify-center gap-2 mt-3">
              <span className="text-[11px] font-bold uppercase tracking-wider px-2 py-1 rounded-lg bg-violet-500/10 text-violet-400">200+ Articles</span>
            </div>
            <button className="w-full mt-5 h-10 rounded-xl bg-violet-500/10 hover:bg-violet-500/20 text-violet-400 text-sm font-semibold transition-all border border-violet-500/20 hover:border-violet-500/40">
              Browse Docs
            </button>
          </div>
        </div>
      ...
      <div className={`relative rounded-2xl overflow-hidden ${
        ...
        <div className="absolute top-0 right-0 w-48 h-48 bg-gradient-to-bl from-amber-500/5 to-transparent rounded-full -translate-y-1/2 translate-x-1/3" />

        <div className="relative p-6">
          {/* Section Header */}
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-amber-500/10 text-amber-400 ring-1 ring-amber-500/20 flex items-center justify-center">
              ...
              pages > 1 && (
                <div className="flex justify-center py-4">
                  <Pagination
                    ...
                    onChange={setPage}
                    classNames={{
                      cursor: "bg-emerald-500 text-white shadow-lg shadow-emerald-500/25",
                      item: isLight
            ...
            <TableBody emptyContent={
              ...
              {paginatedTickets.map((ticket) => (
                <TableRow key={ticket.id}>
                  <TableCell>
                    <span className="font-mono font-medium text-sm text-amber-400">{ticket.id}</span>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <Chip
                      size="sm"
                      classNames={{
                        base: ticket.priority === "High"
                          ? "bg-rose-500/10"
                          : ticket.priority === "Medium"
                          ? "bg-amber-500/10"
                          : "bg-zinc-500/10",
                        content: ticket.priority === "High"
                  ...
                  <TableCell>
                    <Chip
                      ...
                      classNames={{
                        ...
                        content: "text-emerald-400 font-medium text-xs",
                      }}
                    >
                      {ticket.status}
                    </Chip>
                  ...
                  <TableCell>
                    <button className="text-sm text-emerald-400 hover:text-emerald-300 font-medium flex items-center gap-1.5 transition-colors">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className={`group relative rounded-2xl p-5 overflow-hidden transition-all duration-300 ${
          isLight
            ? "bg-white border border-zinc-200 hover:border-pink-500/30"
            : "bg-gradient-to-br from-[#1E1E21] to-[#1a1a1d] border border-[#2A2A2E] hover:border-pink-500/30"
        }`}>
          <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-pink-500/10 to-transparent rounded-full -translate-y-1/2 translate-x-1/3 opacity-50" />
          <div className="relative flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-pink-500/10 text-pink-400 ring-1 ring-pink-500/20 flex items-center justify-center flex-shrink-0">
        ...
        <div className={`group relative rounded-2xl p-5 overflow-hidden transition-all duration-300 ${
          isLight
            ? "bg-white border border-zinc-200 hover:border-emerald-500/30"
            : "bg-gradient-to-br from-[#1E1E21] to-[#1a1a1d] border border-[#2A2A2E] hover:border-emerald-500/30"
        }`}>
          <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-emerald-500/10 to-transparent rounded-full -translate-y-1/2 translate-x-1/3 opacity-50" />
          <div className="relative flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-emerald-500/10 text-emerald-400 ring-1 ring-emerald-500/20 flex items-center justify-center flex-shrink-0">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
